...
<body>
    ...
    <section class="d-grid gap-2 col-6 mx-auto container px-4 ">
        ...
        <form action="http://127.0.1.1/mes-projets/contoller-model-view/cinema/film/creer_film" method="POST">
            ...
            <div class="mb-3" class="card" style="width: 18rem;">
                ...
                <input type="text" class="form-control" name="date" placeholder="Date De Sortie">
            </div>
            <div class="mb-3" class="card" style="width: 18rem;">
                <label for="disabledSelect" class="form-label">Affiche Film</label>
                <input type="text" class="form-control" name="affiche" placeholder="Nom Affiche">
            </div>
            <!-- Selcte genre -->
            <div class="mb-3">
